...
Class levels
	{
	// variables correspondant aux champs de la table levels
	var $id;
	var $uuid;
	var $name;
	var $code;
	...
	function getAllLevels($whereCritere='', $orderCritere='')
		{
		// Requête
		$sql = "SELECT * ";
		$sql .= "FROM levels ";
	...
	function setLevels()
		{
		// Requête
		$sql = "INSERT INTO levels (`uuid`, `name`, `code`, `id`) ";
		$sql .= "VALUES (
	...
	function getNewId()
		{
		$sql = mysql_query(" select max(id) from levels ");
