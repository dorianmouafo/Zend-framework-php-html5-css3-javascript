...
Class languages
	{
	// variables correspondant aux champs de la table languages
	var $id;
	var $uuid;
	var $name;
	var $code;
	...
	function getAllLanguages($whereCritere='', $orderCritere='')
		{
		// Requête
		$sql = "SELECT * ";
		$sql .= "FROM languages ";
	...
	function setLanguages()
		{
		// Requête
		$sql = "INSERT INTO languages (`uuid`, `name`, `code`, `id`) ";
		$sql .= "VALUES (
	...
	function getNewId()
		{
		$sql = mysql_query(" select max(id) from languages ");
