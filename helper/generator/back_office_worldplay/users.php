...
<title>Users - <? echo $dConfig['titreAction']; ?></title>
...
function isDataValid(theForm)
	...
	if(theForm.txt_blob_styles.value == ""){
		alert("Blob_styles invalide!");
		theForm.txt_blob_styles.focus();
		return (false);
		}
	if(theForm.txt_isprof.value == ""){
		alert("Isprof invalide!");
		theForm.txt_isprof.focus();
		return (false);
		}
	}
//-->
  ...
  <tr>
    <td height="100%" colspan="3" bgcolor="#FFFFFF"><div align="center">
      <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><a href="index.php">Administration</a> &gt; Users </td>
        </tr>
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="5">
                <tr valign="top">
                  ...
                  <td><table border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <th bgcolor="#FFFFFF"><div align="left"><strong>Users &raquo; <? echo $dConfig['titreAction']; ?> </strong></div></th>
                      </tr>
                      <form name="formUsers" onSubmit="return(isDataValid(this))" method="post" action="users_sql.php?action=<? echo $_REQUEST['action'];?>">
                        <tr>
                                  ...
                                  <tr>
                                    <td nowrap bgcolor="#FFFFFF"><input type="hidden" name="txt_id" value="<? if ($_REQUEST['id']){echo $_REQUEST['id'];} ?>">
                                        <table width="100%" border="0" cellpadding="3" cellspacing="0">                                           <tr valign="top">
                                            <td nowrap>Uuid</td>
                                            <td><input type="text" name="txt_uuid" maxlength="36" value="<? if ($_REQUEST['id']){echo $newUsers->uuid;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Name</td>
                                            <td><input type="text" name="txt_name" maxlength="32" value="<? if ($_REQUEST['id']){echo $newUsers->name;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Email</td>
                                            <td><input type="text" name="txt_email" maxlength="32" value="<? if ($_REQUEST['id']){echo $newUsers->email;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Password</td>
                                            <td><input type="text" name="txt_password" maxlength="128" value="<? if ($_REQUEST['id']){echo $newUsers->password;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Blob_styles</td>
                                            <td><input type="text" name="txt_blob_styles" maxlength="65535" value="<? if ($_REQUEST['id']){echo $newUsers->blob_styles;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Isprof</td>
                                            <td><input type="text" name="txt_isprof" maxlength="8" value="<? if ($_REQUEST['id']){echo $newUsers->isprof;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                </table>
...
?>
                                <table width="100%"  border="0" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
                                  <tr bgcolor="#CCCCCC">
                                    <th nowrap><div align="left">N&deg;</div></th>                                     <th nowrap><div align="left">Uuid</div></th>                                     <th nowrap><div align="left">Name</div></th>                                     <th nowrap><div align="left">Email</div></th>                                     <th nowrap><div align="left">Password</div></th>                                     <th nowrap><div align="left">Blob_styles</div></th>                                     <th nowrap><div align="left">Isprof</div></th>                                    <? if($_REQUEST['action']!="Consulter"){?>
                                    <th nowrap><div align="left">Op&eacute;ration</div></th>
                                    <? }?>
                                  </tr>
                                  <?
	$array=$newUsers->getAllUsers('id>0','id');
	...
	?>
                                  <tr valign="top">
                                    <td bgcolor="#FFFFFF"><? echo $i+1;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->uuid;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->name;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->email;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->password;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->blob_styles;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->isprof;?></td>                                    <? if($_REQUEST['action']!="Consulter")
			{?>
