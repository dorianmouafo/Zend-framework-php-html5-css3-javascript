...
<title>Questions - <? echo $dConfig['titreAction']; ?></title>
...
function isDataValid(theForm)
	...
	if(theForm.txt_cat_id.value == ""){
		alert("Cat_id invalide!");
		theForm.txt_cat_id.focus();
		return (false);
		}
	if(theForm.txt_qt_id.value == ""){
		alert("Qt_id invalide!");
		theForm.txt_qt_id.focus();
		return (false);
		}
	...
	if(theForm.txt_title.value == ""){
		alert("Title invalide!");
		theForm.txt_title.focus();
		return (false);
		}
	if(theForm.txt_description.value == ""){
		alert("Description invalide!");
		theForm.txt_description.focus();
		return (false);
		}
  ...
  <tr>
    <td height="100%" colspan="3" bgcolor="#FFFFFF"><div align="center">
      <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><a href="index.php">Administration</a> &gt; Questions </td>
        </tr>
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="5">
                <tr valign="top">
                  ...
                  <td><table border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
                      <tr>
                        <th bgcolor="#FFFFFF"><div align="left"><strong>Questions &raquo; <? echo $dConfig['titreAction']; ?> </strong></div></th>
                      </tr>
                      <form name="formQuestions" onSubmit="return(isDataValid(this))" method="post" action="questions_sql.php?action=<? echo $_REQUEST['action'];?>">
                        <tr>
...
if(($_REQUEST['action']=="Enregistrer")||($_REQUEST['id']))
	...
	if($_REQUEST['id'])
		{
		$newQuestions->getQuestions($_REQUEST['id']);
		}
                                  ...
                                  <tr>
                                    <td nowrap bgcolor="#FFFFFF"><input type="hidden" name="txt_id" value="<? if ($_REQUEST['id']){echo $_REQUEST['id'];} ?>">
                                        <table width="100%" border="0" cellpadding="3" cellspacing="0">                                           <tr valign="top">
                                            <td nowrap>Uuid</td>
                                            <td><input type="text" name="txt_uuid" maxlength="36" value="<? if ($_REQUEST['id']){echo $newQuestions->uuid;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Teach_id</td>
                                            <td><input type="text" name="txt_teach_id" maxlength="36" value="<? if ($_REQUEST['id']){echo $newQuestions->teach_id;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Cat_id</td>
                                            <td><input type="text" name="txt_cat_id" maxlength="36" value="<? if ($_REQUEST['id']){echo $newQuestions->cat_id;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Qt_id</td>
                                            <td><input type="text" name="txt_qt_id" maxlength="36" value="<? if ($_REQUEST['id']){echo $newQuestions->qt_id;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Lang_id</td>
                                            <td><input type="text" name="txt_lang_id" maxlength="36" value="<? if ($_REQUEST['id']){echo $newQuestions->lang_id;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Lev_id</td>
                                            <td><input type="text" name="txt_lev_id" maxlength="36" value="<? if ($_REQUEST['id']){echo $newQuestions->lev_id;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Title</td>
                                            <td><input type="text" name="txt_title" maxlength="128" value="<? if ($_REQUEST['id']){echo $newQuestions->title;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Description</td>
                                            <td><input type="text" name="txt_description" maxlength="512" value="<? if ($_REQUEST['id']){echo $newQuestions->description;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                     <tr valign="top">
                                            <td nowrap>Points</td>
                                            <td><input type="text" name="txt_points" maxlength="11" value="<? if ($_REQUEST['id']){echo $newQuestions->points;} ?>" <? if($_REQUEST['action']=="Supprimer"){?>readonly="1"<? }?>></td>
                                                                                </table>
...
?>
                                <table width="100%"  border="0" cellpadding="5" cellspacing="1" bgcolor="#F5F5F5">
                                  <tr bgcolor="#CCCCCC">
                                    <th nowrap><div align="left">N&deg;</div></th>                                     <th nowrap><div align="left">Uuid</div></th>                                     <th nowrap><div align="left">Teach_id</div></th>                                     <th nowrap><div align="left">Cat_id</div></th>                                     <th nowrap><div align="left">Qt_id</div></th>                                     <th nowrap><div align="left">Lang_id</div></th>                                     <th nowrap><div align="left">Lev_id</div></th>                                     <th nowrap><div align="left">Title</div></th>                                     <th nowrap><div align="left">Description</div></th>                                     <th nowrap><div align="left">Points</div></th>                                    <? if($_REQUEST['action']!="Consulter"){?>
                                    <th nowrap><div align="left">Op&eacute;ration</div></th>
                                    <? }?>
                                  </tr>
                                  <?
	$array=$newQuestions->getAllQuestions('id>0','id');
	...
	?>
                                  <tr valign="top">
                                    <td bgcolor="#FFFFFF"><? echo $i+1;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->uuid;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->teach_id;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->cat_id;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->qt_id;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->lang_id;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->lev_id;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->title;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->description;?></td>                                    <td bgcolor="#FFFFFF"><? echo $array[$i]->points;?></td>                                    <? if($_REQUEST['action']!="Consulter")
			{?>
